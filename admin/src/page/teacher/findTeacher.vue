<template>
  <div class="find-person">
    ...
    <el-dialog title="更新" :visible.sync="dialogFormVisible">
      <teacher-form class="person-form" title="更新" :form="form" :onPerson="onSubmit"
                    :dialogFormVisible.sync="dialogFormVisible"></teacher-form>
    </el-dialog>
  </div>
</template>
...
<script>
  ...
  import teacherForm from './child/teacherForm.vue'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        api.teacher.findTeachers(this.listQuery).then(data => {
