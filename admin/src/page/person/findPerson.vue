  ...
  <div class="find-person">
    ...
    <div class="filter-container">
      ...
      <el-table :key='tableKey' ref="personRef" :data="list" v-loading="listLoading" element-loading-text="给我一点时间"
        ...
        <el-table-column width="180px" align="center" label="氪金度">
          <template slot-scope="scope">
            <el-rate
    ...
    <el-dialog title="更新" :visible.sync="dialogFormVisible">
      <person-form class="person-form" title="更新" :form="form" :onPerson="onSubmit"
                   :dialogFormVisible.sync="dialogFormVisible"></person-form>
    </el-dialog>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        api.person.findPersons(this.listQuery).then(data => {
      ...
      onSubmit(obj) {
        ...
        api.person.updatePerson(obj).then(data => {
          console.log(data)
          this.getList()
